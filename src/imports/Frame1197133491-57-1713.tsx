import svgPaths from "./svg-2ovdc9qe28";
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col h-[68px] items-center justify-end relative shrink-0 w-full">
...
export default function Frame9() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative shadow-[0px_6px_24px_0px_rgba(0,0,0,0.2)] size-full">
      <Frame10 />
      <Frame />
    </div>
  );
