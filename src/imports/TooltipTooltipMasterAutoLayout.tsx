...
export default function TooltipTooltipMasterAutoLayout() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center relative size-full" data-name=".Tooltip/Tooltip - Master (Auto Layout)">
      <BeakTop />
      <BeakBubbleBeak />
      <BeakBottom />
    </div>
